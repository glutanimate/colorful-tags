...
ARBITRARY_SUBSTRINGS = local_conf["completerArbitrarySubstrings"]
SEPARATOR = local_conf["Separator"]
HIGHLIGHT_WORKAROUND = local_conf["completerHighlightWorkaround"]
...
class CustomTagEdit(OldTagEdit):
    ...
    def setCol(self, col):
        ...
        if self.type == 0:
            ...
            tags = sorted(self.col.decks.allNames())
        self.model.setStringList(tags)
        self.completer.strings = tags
